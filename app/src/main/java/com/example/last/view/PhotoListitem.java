...
import com.example.last.R;
import com.example.last.view.BaseCustomViewGroup;
import com.example.last.view.state.BundleSavedState;
...
public class PhotoListitem extends BaseCustomViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int newllightMeasureSpec = MeasureSpec.makeMeasureSpec(
                height,
                MeasureSpec.EXACTLY);
        super.onMeasure(widthMeasureSpec, newllightMeasureSpec);
